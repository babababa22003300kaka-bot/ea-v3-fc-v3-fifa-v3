...
# ────────────────────────────────────────────────────────────────────────
# 💰 PRICE CONFIGURATION - إعدادات الأسعار
# ────────────────────────────────────────────────────────────────────────

PRICE_CONFIG = {
    'min_price': int(os.getenv('MIN_PRICE', 1000)),      # 1000 ج.م - الحد الأدنى للسعر
    'max_price': int(os.getenv('MAX_PRICE', 50000)),     # 50000 ج.م - الحد الأقصى للسعر
    'default_amount': int(os.getenv('DEFAULT_AMOUNT', 1000000))  # 1M كوين - الكمية الافتراضية
}
